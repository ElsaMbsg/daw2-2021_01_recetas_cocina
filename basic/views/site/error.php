...
<div class="site-error">
    ...
    <h2 class="center">La página requerida no existe pero aquí tienes un juego en su lugar. Usa <span class="label label-danger">ESPACIO</span> para disparar y <span class="label label-danger">←</span>&#160;<span class="label label-danger">→</span> para moverte.<a class="mx-5 btn btn-warning" href="?r=site/error">Resetear</a> </h2>


    <canvas class="w-75 text-center m-auto my-5" id="space-invaders"/>
